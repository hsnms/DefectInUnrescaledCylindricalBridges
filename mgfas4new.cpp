...
void mgfas4new( double **u, int n, int maxcyc, double m, int a,int b, int *qq,  double *x,  double *y, double R0, double K, double H)
{
	...
	rjac=/*0.9999*//*0.999*//*0.5*/0.99/*0.9 for 33,65; 0.99for 129*/;
